...
public class If_else_if_else2 {
	...
	public static void main(String[] args) {
		 ...
		 * (8) 총취득학점: allTPoint, 총평점계: allSum, 총평점평균: allGAverage
		 * 각 과목의 점수와 과목시수를 입력 받아 각 과목의 '등급, 평점' 출력 
		 * 한학기 '취득학점, 평점계, 평점평균' 출력
		 * 전체학기 '총취득학점, 총평점계 ,총평점평균 
		 */
		...
		if(allTPoint==0) {
			...
			allGAverageF = (float)allsum/allTPoint;
		}
		
		System.out.println("======================");
		System.out.println(  "  총 취득학점: " + allTPoint);
		System.out.println(  "  총 평점계: " + allsum);
		System.out.println(  "  총 평점평균: " + allGAverageF);
